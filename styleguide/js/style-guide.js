...
let styleGuide = {
    ...
    update: function() {
        ...
        // console.log(result);
        // Design system data is contained into:
        ...
        if (document.querySelector('#briks-utilities') !== null) {
            ...
            document.querySelector('#briks-utilities').innerHTML = markup;
        }
    },
    // UPDATE UTILITY
    ...
    updateUtility: function(property) {
        if (typeof property == 'string') {
            ...
            // console.log(pattern_base, el_responsive_checkboxes_array);
            // #utilities-'+property+'-shorthand
            // Build classes
            let classes_names = '';
            let shorthand = pattern_base+'="';
            const css_var_prefix = styleGuide['json']['briks-css-variables-prefix'];
            if (el_responsive_checkboxes_array.length > 0) {
                el_responsive_checkboxes_array.forEach(function(data, index) {
                    ...
                    classes_names += pattern_base+styleGuide.getCssVariable('--'+css_var_prefix+'responsive-prefix')+data.value;
                    // Update shorthand
